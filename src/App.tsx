...
import PointsMaximizer from './components/PointsMaximizer';
      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 w-full max-w-5xl mx-auto">
          {[
            ...
            { to: '/maximize', title: 'Points Maximizer', icon: Sparkles, color: 'bg-rose-500', desc: 'Extract maximum value from card rewards' },
      ...
      <div className="min-h-screen bg-slate-50 font-sans text-slate-900">
        ...
        <nav className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-bottom border-slate-200">
          <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-2">
              ...
              <NavLink to="/maximize" icon={Sparkles}>Maximize</NavLink>
          ...
          <AnimatePresence>
            {isMenuOpen && (
              ...
              >
                ...
                <Link to="/maximize" onClick={() => setIsMenuOpen(false)} className="block px-4 py-3 rounded-xl bg-slate-50 font-medium">Maximize Points</Link>
        ...
        <main className="max-w-7xl mx-auto px-4 py-8">
          <Routes>
            ...
            <Route path="/maximize" element={<PointsMaximizer />} />
        ...
        <footer className="border-t border-slate-200 py-12 bg-white mt-20">
          <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-8">
            ...
            <p className="text-slate-500 text-sm">
              © 2026 Wealth Wizard. Advanced Financial Intelligence Engine.
            </p>
